#this detector aim of analyzing videos from whatever frame
import cv2 as cv
import numpy as np
import pandas as pd
...
def extract_frame(video, frame_number):
    ...
    video.set(cv.CAP_PROP_POS_FRAMES, 9020)
    return frame
...
video = cv.VideoCapture("D:/FutureExpertData/Computervision/GX026449.MP4")
