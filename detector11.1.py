...
video_dir = 'D:/Chris/LubiTracked/videos'
...
#We read the folder that contains the videos
for video_file in os.listdir(video_dir):
    ...
    # Split the video file name to get the base name without extension
    base_name = os.path.splitext(video_file)[0]
 
    with open(f"D:/Chris/LubiTracked/zones_positions/{base_name}.txt", "w") as zones_file, \
        open(f"D:/Chris/LubiTracked/bottle_positions/{base_name}.txt", "w") as lines_file, \
        open(f"D:/Chris/LubiTracked/lines_positions/{base_name}.txt", "w") as boxes_file, \
        open(f"D:/Chris/LubiTracked/bounding_boxes/{base_name}.txt", "w") as bottle_file:
   
        nframe = extract_frame(video, 5000)
